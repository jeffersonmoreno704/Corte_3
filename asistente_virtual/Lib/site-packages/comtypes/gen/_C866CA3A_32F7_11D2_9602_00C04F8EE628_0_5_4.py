...
__all__ = [
    'SREInterference', 'DISPID_SLGenerationId',
    'SAFT44kHz16BitStereo', 'DISPID_SGRName',
    '_ISpeechRecoContextEvents', 'SVP_18', 'SAFTCCITT_uLaw_44kHzMono',
    'SPPS_Function', 'SPEI_TTS_PRIVATE', 'DISPID_SRRTStreamTime',
    'SWPUnknownWordUnpronounceable', 'SDTRule', 'SP_VISEME_3',
    'tagSPTEXTSELECTIONINFO', 'SpPhoneConverter',
    'SPSEMANTICERRORINFO', 'SRSInactiveWithPurge', 'DISPID_SASState',
    'SpeechVisemeFeature', 'ISpObjectTokenCategory',
    'DISPID_SpeechMemoryStream', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRSTs_NewEnum', 'SVP_19',
    'SpSharedRecoContext', 'SAFT32kHz16BitMono', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRSetPropertyString', 'SpeechPartOfSpeech',
    'SAFT48kHz8BitMono', 'DISPID_SpeechPhraseAlternates',
    'eLEXTYPE_PRIVATE7', 'ISequentialStream', 'SpStream',
    'DISPID_SRGReset', 'SPPS_Unknown', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechLexiconPronunciation', 'SVP_13',
    'SAFT32kHz8BitStereo', 'SAFTCCITT_ALaw_22kHzMono', 'SPAR_Unknown',
    'SpeechTokenContext', 'DISPID_SRSNumberOfActiveRules',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRESoundEnd',
    'ISpeechPhraseProperties', 'SpeechSpecialTransitionType',
    'ISpeechAudioStatus', 'ISpeechPhraseAlternates', 'SVP_1',
    'DISPID_SRCESoundStart', 'ISpeechGrammarRule',
    'SpeechRecoContextState', 'SPBO_TIME_UNITS',
    ...
    'eLEXTYPE_PRIVATE10', 'DISPID_SPPFirstElement',
    '_ISpeechVoiceEvents', 'ISpRecoContext2', 'SP_VISEME_5',
    'DISPID_SVResume', 'DISPID_SpeechVoice',
    'DISPID_SLAddPronunciation', 'SPPS_RESERVED2',
    'ISpeechPhraseReplacement',
    'SpeechPropertyLowConfidenceThreshold', 'SBOPause',
    'DISPID_SRCEAdaptation', 'DISPID_SBSFormat',
    'DISPID_SRRGetXMLResult', 'DISPID_SPRuleFirstElement',
    'SVSFPurgeBeforeSpeak', 'ISpDataKey', 'SVEAudioLevel',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVVoice', 'SPEI_REQUEST_UI',
    'DISPID_SFSClose',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'STSF_FlagCreate', 'SPVPRIORITY', 'DISPID_SPEsItem',
    'STCRemoteServer', 'DISPID_SpeechBaseStream', 'ISpRecognizer',
    'DISPID_SPIGetText', 'SPSHORTCUTPAIR', 'SpeechTokenKeyUI',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRSActive',
    'SRAInterpreter', 'DISPID_SVEStreamEnd', 'DISPID_SRCResume',
    'DISPID_SWFEExtraData', 'DISPID_SABufferNotifySize',
    'SPCONTEXTSTATE', 'SVP_12', 'ISpStreamFormat',
    'SSFMOpenReadWrite', 'SPEVENTSOURCEINFO', 'DISPID_SDKEnumKeys',
    'ISpeechPhraseInfoBuilder', 'DISPID_SLPs_NewEnum',
    'ISpGrammarBuilder', 'ISpeechGrammarRuleState',
    'DISPID_SOTDisplayUI', 'SPPHRASE', 'ISpeechAudioBufferInfo',
    'SVP_2', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechPhraseProperty', 'SPBINARYGRAMMAR', 'SPGS_ENABLED',
    'eLEXTYPE_LETTERTOSOUND', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPINTERFERENCE', 'DISPID_SPEsCount', 'DISPID_SDKGetBinaryValue',
    'SP_VISEME_2', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT44kHz8BitMono',
    'SPEI_HYPOTHESIS', 'SPBO_NONE', 'DISPID_SRCEAudioLevel',
    'DISPID_SGRSTType', 'SINoise', 'ISpRecoContext',
    'SVEWordBoundary', 'DISPID_SRCCmdMaxAlternates',
    'SDTPronunciation', 'SPSHT_EMAIL', 'SSSPTRelativeToStart',
    'SpAudioFormat', 'SREBookmark', 'SWPKnownWordPronounceable',
    'SREStreamEnd', 'DISPID_SAFGetWaveFormatEx', 'DISPID_SGRSTWeight',
    'DISPID_SpeechVoiceStatus', 'ISpeechPhraseElement',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_PRIVATE12',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPAsItem',
    'DISPID_SRGetFormat', 'SPDKL_DefaultLocation',
    'ISpeechPhraseProperty', 'SPEI_MIN_SR', 'DISPID_SBSSeek',
    'SPRECOGNIZERSTATUS', 'SpeechGrammarTagWildcard',
    'DISPID_SRCESoundEnd', 'SpWaveFormatEx', 'SREAudioLevel',
    'DISPID_SWFEBitsPerSample', 'SpeechRuleAttributes',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechPhraseProperties',
    'SPEI_INTERFERENCE', 'DISPID_SDKEnumValues',
    'SpPhraseInfoBuilder', 'SPWT_DISPLAY', 'SPPARTOFSPEECH',
    'SVEAllEvents', 'DISPID_SPPId', 'SpeechLexiconType',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SP_VISEME_1',
    'DISPID_SVSpeakStream', 'ISpRecoCategory', 'SITooFast',
    'DISPID_SVEEnginePrivate', 'DISPID_SPCLangId', 'SPSModifier',
    'SVSFParseSsml', 'DISPID_SRGId', 'SAFT12kHz8BitMono', 'ISpAudio',
    'eLEXTYPE_RESERVED10', 'ISpeechObjectTokens',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPARecoResult',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SABIBufferSize', 'SGRSTTEpsilon',
    'SpeechAudioState', 'DISPID_SGRId', 'SPEI_ADAPTATION',
    'DISPID_SRSClsidEngine', 'SAFTGSM610_22kHzMono',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCEventInterests',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechPhraseRule',
    'SAFT11kHz8BitStereo', 'DISPID_SpeechGrammarRules',
    'Speech_StreamPos_RealTime', 'DISPID_SPEPronunciation',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SOTCSetId', 'SSFMCreate', 'SP_VISEME_9',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVEVoiceChange',
    'SVEBookmark', 'DISPID_SPPsItem', 'SDTReplacement',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SGRsDynamic',
    'DISPID_SPEAudioSizeTime', 'SpeechEngineConfidence', 'SGRSTTRule',
    'DISPID_SVSInputSentencePosition', 'DISPID_SLPsItem',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SWFEFormatTag', 'DISPID_SOTId',
    'SREAllEvents', 'SPGS_EXCLUSIVE', 'SpObjectToken',
    'SAFTADPCM_44kHzMono', 'SVP_6', 'ISpeechGrammarRules',
    'DISPID_SRIsShared', 'eLEXTYPE_RESERVED8', 'ISpSerializeState',
    'STSF_CommonAppData', 'ISpeechRecoResult',
    ...
    'SP_VISEME_8', 'SpCompressedLexicon',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPIEnginePrivateData',
    'eLEXTYPE_RESERVED6', 'DISPID_SPIAudioStreamPosition',
    'SpMMAudioEnum', 'DISPID_SLPPhoneIds', 'SPEI_MAX_TTS',
    'SVSFlagsAsync', 'SGDSActiveWithAutoPause', 'SPWORDLIST',
    'SVEViseme', 'SGDSInactive', 'SDA_Consume_Leading_Spaces',
    'SpVoice', 'SPINTERFERENCE_NOSIGNAL', 'ISpeechAudio',
    'SREPropertyStringChange', 'DISPID_SOTRemove',
    'DISPID_SGRSTsCount', 'Speech_Max_Word_Length',
    'DISPID_SRCRecognizer', 'SpMMAudioOut', 'SPWORDTYPE',
    'ISpeechDataKey', 'SVESentenceBoundary', 'ISpeechVoiceStatus',
    'ISpeechWaveFormatEx', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechPhraseElements', 'DISPID_SVEPhoneme',
    'SpeechAudioProperties', 'DISPID_SpeechPhraseRules',
    'Speech_Max_Pron_Length', 'SPPS_SuppressWord',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRCERecognition',
    'SLOStatic', 'SECLowConfidence',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVSInputSentenceLength', 'SDKLCurrentConfig',
    'ISpeechObjectToken', 'SPLO_DYNAMIC', 'DISPID_SVGetVoices',
    'SPFM_NUM_MODES', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SOTCGetDataKey', 'SP_VISEME_13',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVStatus',
    'DISPID_SRGetRecognizers', 'SPINTERFERENCE_LATENCY_WARNING',
    'IInternetSecurityMgrSite', 'SAFT16kHz8BitMono',
    'DISPID_SPRuleId', 'SECFIgnoreCase', 'DISPID_SRRAudio',
    'SpPhoneticAlphabetConverter', 'ISpPhoneticAlphabetSelection',
    'SRATopLevel', 'SAFTDefault', 'DISPID_SRRAudioFormat',
    'DISPID_SGRsCommit', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPERetainedStreamOffset',
    'SAFT8kHz8BitStereo', 'SAFT48kHz8BitStereo', 'SPEI_SR_PRIVATE',
    'DISPID_SRCEHypothesis', 'SPAS_PAUSE', 'SPPS_NotOverriden',
    'DISPID_SOTIsUISupported', 'SREFalseRecognition', 'SpShortcut',
    'SPSInterjection', 'SPAO_RETAIN_AUDIO', 'SPAR_Low',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SCSBaseStream',
    'DISPID_SPPChildren', 'SVSFPersistXML', 'DISPID_SpeechAudio',
    'SPRECOSTATE', 'SPEI_RESERVED5', 'DISPID_SLWPronunciations',
    'SpeechCategoryAudioOut', 'SpeechUserTraining', 'SPFM_CREATE',
    'DISPID_SPRulesCount', 'SpeechCategoryPhoneConverters',
    'SAFTADPCM_11kHzMono', 'ISpRecoGrammar2',
    'SpeechTokenKeyAttributes', 'SpeechPropertyAdaptationOn',
    'DISPID_SWFEAvgBytesPerSec', 'SPPHRASEREPLACEMENT',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRStatus',
    'DISPID_SLGetPronunciations', 'DISPID_SVEViseme',
    'ISpeechPhoneConverter', 'ISpShortcut', 'SAFT12kHz16BitMono',
    'SPEI_RESERVED6', 'SVF_Stressed', 'ISpeechXMLRecoResult',
    'DISPID_SRCERecognizerStateChange', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPBO_AHEAD', 'DISPID_SRGState', 'eLEXTYPE_PRIVATE5',
    'eLEXTYPE_PRIVATE15', 'DISPID_SpeechRecoResultTimes',
    'SPXRO_Alternates_SML', 'DISPID_SLPSymbolic', 'SAFTText',
    'IStream', 'DISPID_SLWs_NewEnum', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SOTDataKey', 'DISPID_SpeechAudioStatus',
    'ISpeechRecoResult2', 'SpCustomStream', 'DISPID_SPPValue',
    'DISPID_SMSADeviceId', 'DISPID_SGRSTPropertyValue',
    'SPCT_SUB_COMMAND', 'SPPS_RESERVED4', 'SVP_7',
    'DISPID_SpeechRecoContextEvents', 'ISpNotifySink', 'SRERequestUI',
    'SpTextSelectionInformation', 'ISpeechRecoResultTimes',
    'DISPID_SPPParent', 'SREPropertyNumChange',
    'SAFTGSM610_11kHzMono', 'DISPID_SAFGuid', 'ISpeechPhraseRule',
    'ISpeechMMSysAudio', 'SPGS_DISABLED', 'SPINTERFERENCE_NOISE',
    'SGSExclusive', 'SPEI_PHONEME', 'SPRST_NUM_STATES',
    ...
    'SDTAll', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPRULESTATE', 'DISPID_SRGRecoContext', 'SPCT_COMMAND',
    'ISpeechRecoResultDispatch', 'ISpeechPhraseAlternate',
    'ISpeechBaseStream', 'SAFT32kHz8BitMono', 'DISPID_SRState',
    'DISPID_SMSALineId', 'SP_VISEME_0', 'SDTAudio',
    'DISPID_SpeechRecoResult2', 'SPADAPTATIONRELEVANCE',
    'SPCS_DISABLED', 'DISPID_SRGRules', 'SAFT22kHz16BitMono',
    'STSF_AppData', 'SP_VISEME_10', 'SpeechGrammarTagDictation',
    'Speech_StreamPos_Asap', 'DISPID_SPRDisplayAttributes',
    'SPRS_ACTIVE_USER_DELIMITED', 'SGLexicalNoSpecialChars',
    'SPSFunction', 'SRAONone', 'SREPhraseStart', 'DISPID_SLPType',
    'SAFT8kHz16BitMono', 'eLEXTYPE_RESERVED4', 'SAFT44kHz8BitStereo',
    'SPSHORTCUTTYPE', 'SPEVENT', 'SECFNoSpecialChars',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCRequestedUIType',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVPOver', 'DISPID_SRCEBookmark',
    'DISPID_SGRAddState', 'SFTSREngine', 'SPSEMANTICFORMAT',
    'DISPID_SLGetWords', 'DISPID_SREmulateRecognition',
    'SPRECORESULTTIMES', 'SPEI_WORD_BOUNDARY',
    'DISPID_SVIsUISupported', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRRSetTextFeedback', 'DISPIDSPRG',
    ...
    'SPINTERFERENCE_NONE', 'ISpeechLexiconPronunciation', 'SLTApp',
    'DISPID_SPRules_NewEnum', 'DISPID_SABIMinNotification',
    'DISPID_SOTGetDescription', 'DISPID_SVEventInterests',
    'SpeechStreamFileMode', 'SPSUnknown', 'eLEXTYPE_PRIVATE14',
    'SP_VISEME_15', 'DISPID_SGRClear', 'DISPID_SPERetainedSizeBytes',
    'SpObjectTokenCategory', 'SPEI_MAX_SR', 'DISPID_SAStatus',
    'DISPID_SRAudioInput', 'SDTLexicalForm',
    'SpeechCategoryRecognizers', 'SGDisplay',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPIRule', 'SPEI_MIN_TTS',
    'DISPID_SRCERequestUI', 'DISPID_SRGDictationLoad',
    'SAFT11kHz16BitStereo', 'SRERecognition', 'SPWORDPRONUNCIATION',
    'ISpeechCustomStream', 'SAFTGSM610_44kHzMono',
    'ISpNotifyTranslator', 'DISPID_SRGSetTextSelection',
    'SPWAVEFORMATTYPE', 'SVSFNLPMask', 'ISpeechRecoContext',
    'SpeechInterference', 'SpeechRetainedAudioOptions',
    'DISPID_SPPs_NewEnum', 'DISPID_SGRSTRule', 'SRADynamic',
    'SpStreamFormatConverter', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpeechAudioFormat', 'SPVPRI_ALERT', 'SPDKL_LocalMachine',
    'DISPID_SABufferInfo', 'DISPID_SPRuleParent',
    'DISPID_SVSInputWordPosition', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechGrammarRule', 'SpeechRecoProfileProperties',
    'eLEXTYPE_PRIVATE18', 'SPPS_Interjection',
    '__MIDL_IWinTypes_0009', 'DISPID_SRAudioInputStream',
    'SP_VISEME_19', 'SAFT32kHz16BitStereo', 'SREHypothesis',
    'SP_VISEME_18', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SGRAddResource', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVSInputWordLength', 'DISPID_SBSRead',
    'SAFT48kHz16BitStereo', 'DISPID_SOTsItem', 'SVF_None',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRCRetainedAudio',
    'SPAR_Medium', 'ISpeechRecognizer', 'SPDKL_CurrentConfig',
    'SVP_11', 'SITooLoud', 'SPWORD', 'ISpeechRecoGrammar',
    'SDKLLocalMachine', 'DISPID_SVSyncronousSpeakTimeout',
    'SpMemoryStream', 'DISPID_SRRSaveToMemory',
    'DISPID_SPIProperties', 'DISPID_SRRTTickCount', 'STCInprocServer',
    'DISPID_SPIGrammarId', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPBOOKMARKOPTIONS', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SDKGetlongValue', 'SpResourceManager', 'SPPS_LMA',
    'DISPID_SRDisplayUI', 'ISpeechRecognizerStatus',
    'DISPID_SPERequiredConfidence', 'DISPID_SWFEBlockAlign',
    'ISpRecoResult', 'SGSEnabled', 'ISpObjectWithToken',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRsItem', 'ISpXMLRecoResult', 'SLODynamic',
    'SAFT24kHz16BitMono', 'SAFT22kHz8BitMono',
    'DISPID_SRGCmdLoadFromObject', 'SPRS_ACTIVE',
    'SPEI_PROPERTY_NUM_CHANGE', 'SDA_One_Trailing_Space',
    'ISpEventSink', 'DISPID_SVGetProfiles', 'SPPHRASEPROPERTY',
    'SPGRAMMARSTATE', 'SPWF_INPUT', 'SPINTERFERENCE_TOOLOUD',
    'SP_VISEME_7', 'SRARoot', 'SSFMCreateForWrite',
    'DISPID_SPRuleChildren', 'SPEI_RESERVED3', 'DISPID_SPRulesItem',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRIsUISupported',
    'DISPID_SVDisplayUI', 'DISPID_SPRs_NewEnum',
    'DISPID_SpeechPhraseElement', 'SpeechAudioFormatGUIDText',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechResourceLoader', 'SASPause', 'SP_VISEME_16',
    'SPEVENTENUM', 'SPFM_OPEN_READONLY', 'DISPID_SDKGetStringValue',
    'DISPID_SGRSAddSpecialTransition', 'SECFIgnoreKanaType',
    'DISPID_SRGetPropertyString', 'ISpRecoGrammar', 'SPFILEMODE',
    'SVPNormal', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechRecognizerStatus', 'SVP_0',
    'DISPID_SRCVoicePurgeEvent', 'SPAO_NONE', 'SRAImport',
    'SpeechMicTraining', 'SREStateChange', 'DISPID_SLWLangId',
    'SAFT24kHz8BitStereo', 'SpNotifyTranslator',
    'SAFT16kHz16BitStereo', 'DISPID_SLWType',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVEStreamStart',
    'SVP_16', 'SRTAutopause', 'SSFMOpenForRead',
    'DISPID_SVSPhonemeId', 'Speech_Default_Weight',
    'DISPID_SLPPartOfSpeech', 'DISPID_SGRAttributes',
    'SVEVoiceChange', 'DISPID_SMSSetData',
    'DISPID_SPEDisplayAttributes', 'DISPID_SDKSetStringValue',
    'SpeechWordType', 'SPRST_ACTIVE', 'SGSDisabled',
    'DISPID_SDKSetBinaryValue', 'SPINTERFERENCE_TOOSLOW',
    'SPLO_STATIC', 'SFTInput', 'DISPID_SVPause', 'SPCT_DICTATION',
    'DISPID_SPEActualConfidence', 'SPVPRI_OVER', 'DISPID_SPAsCount',
    'DISPID_SLPLangId', 'DISPID_SRGDictationSetState',
    'DISPID_SRGCmdSetRuleState', 'SpMMAudioIn', 'DISPID_SPACommit',
    'DISPID_SPPName', 'eWORDTYPE_DELETED', 'SpeechCategoryAudioIn',
    'DISPID_SRRPhraseInfo', 'DISPID_SVWaitUntilDone',
    'DISPID_SOTCDefault', 'SPSSuppressWord', 'SASClosed',
    'SpeechVisemeType', 'SAFT16kHz8BitStereo',
    'SpeechPropertyResponseSpeed', 'ISpStream',
    'DISPID_SPRFirstElement', 'SpeechDisplayAttributes',
    'DISPID_SRRRecoContext', 'DISPID_SRCSetAdaptationData',
    'SpeechAddRemoveWord', 'SPSVerb', 'SLTUser',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_PRIVATE2',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLGetGenerationChange',
    'ISpObjectToken', 'eLEXTYPE_PRIVATE1',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPIAudioSizeBytes', 'SRTReSent',
    'DISPID_SpeechRecognizer', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRCEEnginePrivate', 'DISPID_SAEventHandle',
    'DISPID_SPISaveToMemory', 'DISPID_SLWWord', 'SPAUDIOSTATUS',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVAudioOutputStream',
    'SDA_No_Trailing_Space', 'SPWORDPRONOUNCEABLE',
    'SAFT8kHz8BitMono', 'SpeechRecoEvents', 'SVP_10', 'SVP_21',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechPhraseReplacement', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpProperties', 'SRSEDone', 'eLEXTYPE_RESERVED7',
    'SPEI_SOUND_END', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechMMSysAudio', 'SWTDeleted',
    'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPCATEGORYTYPE',
    'ISpEventSource', 'SAFT11kHz16BitMono', 'DISPID_SRCPause',
    '_RemotableHandle', 'ISpeechPhraseInfo', 'DISPID_SDKCreateKey',
    'DISPID_SGRs_NewEnum', 'SSSPTRelativeToCurrentPosition',
    'SVEStartInputStream', 'SP_VISEME_20', 'SPSNotOverriden',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVRate',
    'SVSFIsFilename', 'DISPID_SGRSTransitions', 'SpeechAudioVolume',
    'SPEI_END_SR_STREAM', 'SPPS_Verb', 'DISPID_SPIStartTime',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechAudioBufferInfo',
    'SP_VISEME_21', 'SpeechDiscardType', 'SPEI_RESERVED1',
    'DISPID_SLRemovePronunciation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechRegistryLocalMachineRoot', 'SRESoundStart',
    'DISPID_SRSSupportedLanguages', 'STCLocalServer',
    'DISPID_SVVolume', 'DISPID_SpeechObjectTokens',
    'DISPID_SOTsCount', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCEStartStream', 'SPAS_RUN', 'SPFM_CREATE_ALWAYS',
    'DISPID_SGRSAddRuleTransition', 'SGRSTTTextBuffer',
    'DISPID_SVAudioOutput', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPSHT_Unknown', 'DISPID_SpeechDataKey', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRRTLength', 'SDTProperty', 'SINone',
    'SpeechDataKeyLocation', 'SpeechDictationTopicSpelling',
    'SAFT24kHz8BitMono', 'ISpMMSysAudio', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRCCreateGrammar', 'SpNullPhoneConverter',
    'DISPID_SpeechLexicon', 'DISPID_SRCEEndStream',
    'eLEXTYPE_PRIVATE8', 'SVSFIsXML', 'DISPID_SOTCategory',
    'SVSFUnusedFlags', 'SPPS_Modifier', 'SSSPTRelativeToEnd',
    'SECFDefault', 'SpeechGrammarState', 'SITooSlow',
    'SpeechEngineProperties', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPSMF_UPS', 'SSTTTextBuffer', 'SAFTADPCM_8kHzMono',
    'SDKLCurrentUser', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SGRSRule', 'SAFT48kHz16BitMono',
    'SDA_Two_Trailing_Spaces', 'SVP_15', 'SPEI_RECOGNITION',
    'DISPID_SLWsCount', 'SVP_4', 'SVP_14', 'SVP_3',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPAPhraseInfo',
    'DISPID_SPIReplacements', 'DISPID_SRRecognizer',
    'DISPID_SRGIsPronounceable', 'SITooQuiet',
    'SpeechRecognizerState', 'SpeechFormatType', 'SPPS_RESERVED3',
    'SPSTREAMFORMATTYPE', 'SRAORetainAudio', 'SPSMF_SAPI_PROPERTIES',
    'SPAR_High', 'SPTEXTSELECTIONINFO', 'UINT_PTR',
    'DISPID_SOTCreateInstance', 'SASRun', 'DISPID_SRSAudioStatus',
    'SPSERIALIZEDPHRASE', 'SVSFDefault', 'DISPID_SABIEventBias',
    'SPVISEMES', 'DISPID_SOTs_NewEnum', 'SPEI_VOICE_CHANGE',
    'DISPID_SPIGetDisplayAttributes', 'SPEI_SR_BOOKMARK',
    'DISPID_SPRsCount', 'DISPID_SVEWord',
    'DISPID_SPAStartElementInResult', 'SAFTExtendedAudioFormat',
    'SVSFParseSapi', 'ISpeechLexiconWords', 'SpeechVoicePriority',
    'STCInprocHandler', 'eLEXTYPE_RESERVED9',
    'DISPID_SVAlertBoundary', 'SPLOADOPTIONS', 'DISPID_SRCState',
    'SDKLDefaultLocation', 'SVEPrivate', 'SDTAlternates',
    'SPWORDPRONUNCIATIONLIST', 'SVEEndInputStream',
    'SAFTGSM610_8kHzMono', 'eLEXTYPE_USER', 'SP_VISEME_14',
    'SPCS_ENABLED', 'SVSFParseAutodetect', 'DISPID_SPIElements',
    'SpUnCompressedLexicon', 'SGDSActive', 'SPCT_SLEEP',
    'IInternetSecurityManager', 'eLEXTYPE_PRIVATE16',
    'SPEI_END_INPUT_STREAM', 'SVP_8', 'SPPS_Noncontent', 'SpLexicon',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRInitialState',
    'DISPID_SVSkip', 'DISPID_SPRText', 'SVP_5', 'SpInprocRecognizer',
    'SAFTCCITT_uLaw_22kHzMono', 'SRSEIsSpeaking',
    'SpeechWordPronounceable', 'DISPID_SRGCmdLoadFromResource',
    'SAFT24kHz16BitStereo', 'SPXMLRESULTOPTIONS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPSHT_NotOverriden', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechPhraseElements', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCEInterference', 'DISPID_SVSLastBookmarkId',
    'SPCT_SUB_DICTATION', 'SPXRO_SML', 'DISPID_SPRuleName',
    'SECFIgnoreWidth', 'SAFT12kHz16BitStereo', 'SPEI_SOUND_START',
    'DISPID_SRRTOffsetFromStart', 'SPAS_STOP',
    'DISPID_SDKSetLongValue', 'SPSLMA', 'SWTAdded', 'SRCS_Disabled',
    'eLEXTYPE_PRIVATE17', 'tagSPPROPERTYINFO', 'eLEXTYPE_PRIVATE13',
    'SRERecoOtherContext', 'SpeechGrammarWordType',
    'DISPID_SWFEChannels', 'DISPID_SpeechVoiceEvent',
    'SWPUnknownWordPronounceable', 'SPGRAMMARWORDTYPE',
    'SpeechRunState', 'DISPID_SRGDictationUnload',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSLastBookmark',
    'eLEXTYPE_PRIVATE4', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVSCurrentStreamNumber', 'SPPS_Noun',
    'DISPID_SPAs_NewEnum', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_17', 'SPSERIALIZEDRESULT', 'SPPROPERTYINFO',
    'SPVOICESTATUS', 'SGLexical', 'SP_VISEME_12',
    'DISPID_SWFESamplesPerSec', 'ISpRecognizer3',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVPriority',
    'DISPID_SRRAlternates', 'DISPID_SGRSTsItem',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPRuleEngineConfidence',
    'tagSTATSTG', 'SpInProcRecoContext', 'SP_VISEME_4',
    'ISpRecognizer2', 'eLEXTYPE_APP', 'SAFT22kHz8BitStereo',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechLexiconWord', 'SRTEmulated', 'ISpPhrase',
    'SPVPRI_NORMAL', 'SpeechLoadOption', 'eLEXTYPE_PRIVATE9',
    'SP_VISEME_6', 'DISPID_SFSOpen', 'DISPID_SGRSTPropertyName',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVSFParseMask',
    'DISPID_SpeechObjectToken', 'SpeechRuleState',
    'DISPID_SRRSpeakAudio', 'ISpeechFileStream', 'SREPrivate',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechGrammarRuleState',
    'SDTDisplayText', 'SPPHRASERULE',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGCmdSetRuleIdState', 'SGDSActiveUserDelimited',
    'ISpeechLexiconWord', 'ISpeechObjectTokenCategory',
    'SVSFVoiceMask', 'SPEI_TTS_BOOKMARK',
    'DISPIDSPTSI_SelectionOffset', 'eWORDTYPE_ADDED',
    'SPPHRASEELEMENT', 'DISPID_SVEBookmark',
    'DISPID_SPRNumberOfElements', 'SECNormalConfidence',
    'DISPID_SVEAudioLevel', 'ISpResourceManager', 'SVP_9',
    'DISPID_SGRSTText', 'WAVEFORMATEX', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRCRetainedAudioFormat', 'SGRSTTDictation', 'SPEI_VISEME',
    'SVP_17', 'SGRSTTWildcard', 'SGPronounciation',
    'SpeechStreamSeekPositionType', 'SPRECOCONTEXTSTATUS',
    'ISpStreamFormatConverter', 'DISPID_SASCurrentDevicePosition',
    'SPBO_PAUSE', 'SRSInactive', 'SpeechCategoryAppLexicons',
    'DISPID_SPEs_NewEnum', 'DISPID_SVSVisemeId',
    'DISPID_SOTGetAttribute', 'SECHighConfidence',
    'DISPID_SMSAMMHandle', 'DISPID_SRProfile',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRsCount', 'SRAExport',
    'SASStop', 'DISPID_SpeechWaveFormatEx', 'DISPID_SPEDisplayText',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPPConfidence',
    'SAFT11kHz8BitMono', 'SpeechCategoryVoices', 'SVSFIsNotXML',
    'SAFTNonStandardFormat', 'SBONone', 'SpeechBookmarkOptions',
    'SRADefaultToActive', 'SpeechCategoryRecoProfiles', 'DISPIDSPTSI',
    'DISPID_SASetState', 'DISPID_SpeechCustomStream',
    'DISPID_SMSGetData', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPRS_INACTIVE', 'DISPID_SPCIdToPhone',
    'DISPID_SRGSetWordSequenceData', 'SRTExtendableParse',
    'DISPID_SASNonBlockingIO', 'SPWF_SRENGINE', 'SPRULE',
    'ISpPhraseAlt', 'DISPID_SRGCommit', 'DISPID_SPPsCount',
    'DISPID_SRSCurrentStreamPosition', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SDKOpenKey',
    'SAFTNoAssignedFormat', 'ISpLexicon', 'DISPID_SRCEPhraseStart',
    'SSTTDictation', 'DISPID_SRCreateRecoContext', 'DISPID_SAFType',
    'SRCS_Enabled', 'SpeechVoiceEvents', 'SpFileStream',
    'ISpNotifySource', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SBSWrite',
    'DISPID_SRGetPropertyNumber', 'ISpeechLexicon', 'SVF_Emphasis',
    'SPLEXICONTYPE', 'DISPID_SPIEngineId', 'DISPID_SDKDeleteKey',
    'SGRSTTWord', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SVSLastResult', 'SpeechRegistryUserRoot',
    'DISPID_SpeechFileStream', 'DISPID_SPEEngineConfidence',
    'SpeechRecognitionType', 'SPAS_CLOSED', 'SPAUDIOSTATE',
    'SECFEmulateResult', 'SINoSignal', 'SpeechAudioFormatType',
    'DISPID_SOTSetId', 'IEnumSpObjectTokens',
    'DISPID_SVSRunningState', 'SPEI_RESERVED2',
    'DISPID_SADefaultFormat', 'SpeechTokenValueCLSID',
    'DISPID_SRRTimes', 'SP_VISEME_11', 'DISPID_SpeechLexiconWords',
    'SVEPhoneme', 'DISPID_SASCurrentSeekPosition', 'DISPID_SGRsAdd',
    'STCAll', 'ISpeechPhraseRules', 'SPINTERFERENCE_TOOQUIET',
    'SRTSMLTimeout', 'STSF_LocalAppData', 'DISPID_SLWsItem',
    'DISPID_SpeechRecoContext', 'SAFT22kHz16BitStereo',
    'DISPID_SLPsCount', 'SPEI_UNDEFINED', 'ISpVoice',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFT8kHz16BitStereo',
    'DISPID_SPANumberOfElementsInResult', 'SPAUDIOOPTIONS',
    'LONG_PTR', 'SPSHT_OTHER', 'SpeechTokenIdUserLexicon',
    'IEnumString', 'DISPID_SASFreeBufferSpace', 'SPSHORTCUTPAIRLIST',
    'SPAUDIOBUFFERINFO', 'SPWT_PRONUNCIATION',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechLexiconProns',
    'ISpeechGrammarRuleStateTransition', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SVESentenceBoundary', 'SPSNoun',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPILanguageId',
    'DISPID_SDKDeleteValue', 'eLEXTYPE_PRIVATE19',
    'SpSharedRecognizer', 'DISPID_SRCVoice',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechTextSelectionInformation',
    'SPDKL_CurrentUser', 'SRTStandard', 'ISpPhoneConverter',
    'SVPAlert', 'SPEI_PHRASE_START', 'DISPID_SOTCId',
    'DISPID_SVSpeak', 'SVP_20', 'ISpeechMemoryStream',
    'DISPID_SRCBookmark', 'SPRST_INACTIVE', 'DISPID_SGRsFindRule',
    'SREAdaptation', 'SAFT44kHz16BitMono', 'SPPS_RESERVED1',
    'DISPID_SPRsItem', 'SpeechTokenKeyFiles',
    'DISPID_SRCERecognitionForOtherContext', 'SREStreamStart',
    'DISPID_SPCPhoneToId', 'SRSActiveAlways',
    'DISPID_SGRsCommitAndSave', 'SSTTWildcard',
    'DISPID_SpeechAudioFormat', '_SPAUDIOSTATE', 'ISpeechVoice'
]

_check_version('1.2.0', 1698454059.029214)
